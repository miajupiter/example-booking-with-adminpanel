      ...
      <section className=" py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <p className="text-justify text-gray-700 overflow-y-scroll bg-white p-4 h-60">
            At TourAbi, our mission is to empower your travel dreams and create
            ...
            level of comfort, safety, and enjoyment. At TourAbi, we are dedicated
            ...
            mission at TourAbi is to empower your travel dreams by providing
          ...
          />
          <p className="text-justify text-gray-700 overflow-y-scroll bg-white p-4 h-60 ">
            At TourAbi, our mission is to be your gateway to extraordinary
            ...
            available. In conclusion, our mission at TourAbi is to serve as your
          ...
          />
          <p className="text-justify text-gray-700  overflow-y-scroll bg-white p-4 h-60">
            At TourAbi, our mission is to help you discover the world, connect
            ...
            TourAbi is to help you discover, connect with cultures, and thrive
